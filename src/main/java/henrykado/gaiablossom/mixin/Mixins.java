...
public enum Mixins {
    ...
    // SKELETON_LOWERSARMS(Phase.EARLY, Side.CLIENT, () -> Config.renderSkeletonChargingBow,
    // "client.MixinModelSkeleton"),
    ...
    THAUMCRAFT_TAINTWOOD_SPREAD(Phase.LATE, Side.BOTH, TargetedMod.THAUMCRAFT,
        () -> Config.taintedTrees && !Loader.isModLoaded("ForbiddenMagic"), "thaumcraft.MixinBlockTaintFibres"),
    ...
    THAUMCRAFT_EXCAVATEVISCOST(Phase.LATE, Side.BOTH, TargetedMod.THAUMCRAFT, () -> Config.excavationEarthVisCost == 15,
        "thaumcraft.foci.MixinFocusExcavation"),
    THAUMCRAFT_SHOCKVISCOST(Phase.LATE, Side.BOTH, TargetedMod.THAUMCRAFT, () -> Config.shockAirVisCost != 15 || Config.earthShockAirVisCost != 75 || Config.chainShockAirVisCost != 40,
        "thaumcraft.foci.MixinFocusShock"),
    THAUMCRAFT_FIREVISCOST(Phase.LATE, Side.BOTH, TargetedMod.THAUMCRAFT, () -> Config.fireVisCost != 10 || Config.fireballVisCost != 66,
        "thaumcraft.foci.MixinFocusFire"),
